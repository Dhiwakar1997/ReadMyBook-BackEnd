"""
Insert image tags into Markdown at the correct positions using
page-aware fuzzy sentence matching.
"""
...
def insert_images_into_markdown(
    ...
    _ = images_rel_dir  # Retained for call compatibility; tags now use filename-only paths.
