...
class ImageService:
    ...
    def get_image_download_url(self, document_id: str, image_name: str, expiry_minutes: int = 60) -> str:
        ...
        """
        # Construct the blob path: document_id/imagename
    ...
    def get_images_download_urls(self, document_id: str, image_names: List[str], expiry_minutes: int = 60) -> Dict[str, str]:
        ...
        Args:
            ...
            expiry_minutes: Number of minutes until the URLs expire (default: 60)
        
        Returns:
            Dictionary with image_name as key and download_url as value
        """
        if not image_names:
            return {}
